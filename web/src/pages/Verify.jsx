      ...
      <div className="max-w-5xl w-full rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[600px]">
        ...
        <div className="w-full md:w-1/2 p-8 sm:p-12 flex flex-col justify-center bg-blue-100/50 dark:bg-slate-800/50 transition-colors duration-500">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-white mb-2 opacity-80">
              Serani AI
            </h2>
          ...
          {error && (
            <p className="text-red-500 text-center mb-4 bg-white/80 p-2 rounded">
              {error}
            </p>
          )}
          ...
          >
            <div>
              <label className="block text-slate-700 dark:text-slate-300 text-sm font-semibold mb-2 text-center">
                Enter 6-Digit Code
              </label>
              <input
                type="text"
          ...
          <div className="mt-6 text-center">
            ...
            {resendMessage && (
              <p className="text-green-300 text-xs mt-2">{resendMessage}</p>
            )}
        ...
        <div className="hidden md:flex w-1/2 bg-[#f0f9ff] dark:bg-gray-800 flex-col items-center justify-center relative transition-colors duration-300">
          ...
          />
          <h1 className="text-5xl font-bold text-black dark:text-white mb-2 transition-colors">
            Almost There!
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 font-medium transition-colors">
            Secure your account
          </p>
